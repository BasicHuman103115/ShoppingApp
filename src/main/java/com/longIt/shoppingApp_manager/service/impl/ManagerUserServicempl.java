...
public class ManagerUserServicempl implements ManagerUserServiceI {
	...
	public String getUserByLoginName(String loginName) {
	 ...
	 //获取所有用户信息
		...
		@Override
		public void LoginDate(User user) {
			// TODO Auto-generated method stub
			user.setLogin_time(new Date());
			userMapper.LoginDate(user);
		}
		

		@Override
		public void LogoutDate(User user) {
			// TODO Auto-generated method stub
			user.setLogout_time(new Date());
			userMapper.LogoutDate(user);
		}

		@Override
		public void LoginIP(User user, String IPadd) {
			// TODO Auto-generated method stub
			user.setLoginIP(IPadd);
			userMapper.LoginIP(user);
		}
